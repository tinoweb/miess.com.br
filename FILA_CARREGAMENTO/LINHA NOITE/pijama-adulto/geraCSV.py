        ...
        for product_data in product_data_list:
            ...
            for variation in product_data["Variações do produto"]:
                if variation["Disponibilidade"]:  # Verifica se a variação está disponível
                    ...
                    variant_price = original_price * 1.5
                    ...
                    # Processo adicional com as informações de variação, se necessário
                    
                    # Pare o loop se você só precisa do preço de uma variação disponível, 
