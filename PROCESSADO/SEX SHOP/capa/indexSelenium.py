...
url_categoria = 'https://www.miess.com.br/sex-shop/capa'
...
def get_product_details(url):
    ...
    if response.status_code == 200:
        ...
        # with open('capa.html', 'w', encoding='utf-8') as file:
...
def processar_pagina(url_base):
    ...
    # html_content = soup.prettify()
    # with open('capaar.html', 'w', encoding='utf-8') as file:
    #     file.write(html_content)
    ...
    while current_page <= numero_de_paginas:
        ...
        produtos = soup.find_all('li', class_=sexshop)
